var store = [{
        ...
        "title": "TIL #13",
        "excerpt":"계산기 이쁘게 구현하기 오늘은 계산기에 대해 기본적인 구현방법에 대해서 배워보고 직접 해보는 시간을 가졌다. 어느정도 할 줄을 알았기에 나는 빠르게 구현을 끝내고 CSS에 집중을 했다. 많은 동기들이 계산기를 구현하느라 JS파일에만 집중을해서 대부분 동기들이 CSS부분은 건드리지도 못한 것 같았다. 그래서 나는 구현을 빨리 끝내고 CSS파일을 많이 건드려봤다. 내가 알고 있는 지식을...","categories": ["2021/01"],
        "tags": ["Pre-Course","HTML&CSS"],
        "url": "http://localhost:4000/2021/01/TIL13/",
        "teaser": null
      },{
        "title": "TIL #14",
        "excerpt":"반복문은 정말 셀 수 없을 정도로 복습을 많이 한 것 같다. 아는 내용도 또 풀고, 모르는 내용은 그거에 몇 십번은 더 풀어보고 할 정도였다... 오늘은 이번주 중에서 반복문이 핵심내용이였기 때문에 한 번 더 복습하려고 한다. 내 TIL에서 마지막 반복문 블로깅이 될 것 같다. 반복문 기초 알고리즘 :point_right: while을 사용해서 홀수...","categories": ["2021/01"],
        "tags": ["Pre-Course"],
        "url": "http://localhost:4000/2021/01/TIL14/",
        "teaser": null
      }]
